...
public class LocationManager extends CordovaPlugin implements BeaconConsumer {
  ...
  private static final String SERVICE_UUID = "00003412-0000-1000-8000-00805f9b34fb";
  private static final String CHARACTERISTIC_UUID = "00000000-0000-656b-6962-5f3030345450";
  ...
  private BluetoothAdapter.LeScanCallback mLeScanCallback = new BluetoothAdapter.LeScanCallback() {
    ...
    public void onLeScan(final BluetoothDevice device, int rssi,
                         byte[] scanRecord) {
      if(identifier.equals(device.getName())) {
        Log.d(TAG, "Found BLE device: " + device.getName());
        ...
        if (status == BluetoothGatt.GATT_SUCCESS) {
          ...
          /*for(BluetoothGattService service : gatt.getServices()) {
            ...
            for (BluetoothGattCharacteristic characteristic : service.getCharacteristics()) {
              Log.d(TAG, "Discovered characteristic: " + characteristic.getUuid());
            }
          }*/
          BluetoothGattService service = gatt.getService(UUID.fromString(SERVICE_UUID));
          BluetoothGattCharacteristic characteristic = service.getCharacteristic(UUID.fromString(CHARACTERISTIC_UUID));
          characteristic.setValue("1234_0");
          boolean result = mBluetoothGatt.writeCharacteristic(characteristic);
          gatt.close();
          Log.i(TAG, "Characteristic written: " + result);
        } else {
